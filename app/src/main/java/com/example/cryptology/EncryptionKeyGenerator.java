...
public class EncryptionKeyGenerator {
    ...
    static SecurityKey generateSecretKeyPre18(Context context) {
        ...
        try {
            ...
            Timber.d("Secret Key Fetched :%s", new String(pkEntry.getSecretKey().getEncoded(), StandardCharsets.UTF_8));
    ...
    private static void saveMyKeystore(Context context, KeyStore androidCAStore, char[] password,
        ...
        Timber.d("Secret Key Saved : %s", new String(mySecretKey.getEncoded(), StandardCharsets.UTF_8));
    }
}
